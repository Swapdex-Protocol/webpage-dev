...
const BlockchainButton = ({ buttonName, className, textClasses }) => (
  <div className={`flex rounded-xl cursor-pointer border-2 border-white transition ease-in-out delay-75 bg-white/[0.2] hover:bg-white/80 backdrop-blur-xl  ${className}`} onClick={() => { console.log('tested'); }}>
